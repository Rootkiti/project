...
if(isset($_POST["action"]))
{
      ...
      if($_POST["action"] == "search")
      {
        ...
        $data = $_POST["search_value"];
        $folder = $_POST["folder"];
	  $query=$db->prepare("SELECT * FROM archives where (documentCode = :data || phone like '$_POST[search_value]%' || fname like '$_POST[search_value]%' || lname like '$_POST[search_value]%') &&(folder = :folder)");
       $query->execute(array(':data'=>$data, ':folder'=>$folder));
