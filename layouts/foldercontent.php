   ...
   <?php  }
    ...
    ?>
      ...
      <?php endif; }
       ...
       foreach ($list as $list2) { 
           $parentFolder = $list2->parentfolder;
    ...
    ?>
       ...
       foreach ($list as $list2) { ?>
           ...
           <tr> 
              ...
              &nbsp;
                <a onclick="return confirm('Are Your sure You Want To Delete This Record ?')" href="delete.php?id=<?= $list2->id; ?>&folder=<?= $list2->folder;?>&path=<?=$path;?>" style="text-decoration: none;">
         ...
         <?php
          ...
          if($page>1)
          {
            echo"<a href='foldercontent.php?page=".($page-1)."&id=".$folder."' class='btn btn-danger m-1'>Previous</a>";
            
          }
          for($i=1; $i<$total_pages; $i++)
          {
            echo"<a href='foldercontent.php?page=".$i."&id=".$folder."' class='btn btn-primary'>$i</a>";
            
          }
          if($i>$page)
          {
            echo"<a href='foldercontent.php?page=".($page+1)."&id=".$folder."' class='btn btn-danger'>Next</a>";
          }
...
<?php
       ...
       $idquery=$db->prepare("SELECT documentCode FROM archives order by documentCode desc");
